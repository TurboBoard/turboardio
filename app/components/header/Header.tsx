        ...
        <div className="gutter pt-7 pb-6 lg:pb-5">
            <div className="relative z-10 flex justify-between items-center text-light">
                <div className="flex-1 flex justify-start">
                    <Link className="opacity-link block h-7 md:h-8 lg:h-9 transform translate-y-3 md:translate-y-4 lg:translate-y-5" href="/">
                        <Logo />
                    </Link>
                </div>

                <Link className="opacity-link font-heading text-xl md:text-2xl lg:text-4xl leading-none tracking-wide whitespace-nowrap" href="/bounties">
                    Bounty Board
                </Link>
